using OVB.Demos.Ecommerce.Microsservices.Base.Infrascructure.Retry.Configuration.ENUMs;
using OVB.Demos.Ecommerce.Microsservices.Base.Infrascructure.Retry.Configuration.Interfaces;
using Polly;
using Polly.Retry;

namespace OVB.Demos.Ecommerce.Microsservices.Base.Infrascructure.Retry.Configuration;
