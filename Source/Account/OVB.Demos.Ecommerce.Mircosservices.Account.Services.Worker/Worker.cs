...
public class Worker : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        {
            await _traceManager.StartTracing("Worker.CreateAccountExecuteAsync", ActivityKind.Consumer, (activity) =>
            {
                return Task.FromResult(_rabbitMQConsumer.ConsumeMessage(async (information) =>
                {
