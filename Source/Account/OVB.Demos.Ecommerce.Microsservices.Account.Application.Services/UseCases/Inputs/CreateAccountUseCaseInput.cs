namespace OVB.Demos.Ecommerce.Microsservices.Account.Application.Services.UseCases.Inputs;

public sealed class CreateAccountUseCaseInput
{
    public CreateAccountUseCaseInput(Guid tenantIdentifier, Guid correlationIdentifier, string sourcePlatform, string executionSource, 
